...
DIR_STEAMCMD="/home/dylan/csgo_server"
STEAM_LOGIN="anonymous"
STEAM_PASSWORD=""
STEAM_RUNSCRIPT="$DIR_STEAMCMD/runscript_$SCREEN_NAME"

DIR_GAME="$DIR_STEAMCMD/csgo-ds"
DIR_LOGS="$DIR_GAME/logs"
DAEMON_GAME="srcds_run"

UPDATE_LOG="$DIR_LOGS/update_`date +%Y%m%d`.log"
UPDATE_EMAIL="dtuominen@gmail.com"
UPDATE_RETRY=3
PARAM_START="-game csgo -console -usercon -port 27016 +game_type 0 +game_mode 1 +host_workshop_collection 125606752 +workshop_start_map 125488374 -authkey 7D54A7A47568B9ADF2179D8709AE6B0A"
PARAM_UPDATE="+login ${STEAM_LOGIN} +force_install_dir ${DIR_GAME} +app_update 740 validate +quit"
